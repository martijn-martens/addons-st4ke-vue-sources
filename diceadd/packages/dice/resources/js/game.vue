      ...
      <v-row justify="center">
        <v-col cols="3" md="2" lg="1" class="text-center">
          <v-card :elevation="3" :loading="playing">
            <animated-number :number="parseInt(rollDigits[0], 10)" :animating="playing" :class="[{ blur: win > 0 }, 'digit']" />
          </v-card>
        </v-col>
        <v-col cols="3" md="2" lg="1" class="text-center">
          <v-card :elevation="3" :loading="playing">
            <animated-number :number="parseInt(rollDigits[1], 10)" :animating="playing" :class="[{ blur: win > 0 }, 'digit']" />
          </v-card>
        </v-col>
        <v-col cols="3" md="2" lg="1" class="text-center">
          <v-card :elevation="3" :loading="playing">
            <animated-number :number="parseInt(rollDigits[2], 10)" :animating="playing" :class="[{ blur: win > 0 }, 'digit']" />
          </v-card>
        </v-col>
        <v-col cols="3" md="2" lg="1" class="text-center">
          <v-card :elevation="3" :loading="playing">
            <animated-number :number="parseInt(rollDigits[3], 10)" :animating="playing" :class="[{ blur: win > 0 }, 'digit']" />
          </v-card>
        </v-col>
      </v-row>
    </div>
...
export default {
  ...
  components: { PlayControls, AnimatedNumber },
