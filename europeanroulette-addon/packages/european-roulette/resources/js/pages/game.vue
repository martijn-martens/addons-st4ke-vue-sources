          ...
          <object class="roulette-source">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 829.1 829.3">
              <g ref="wheel" style="transform-origin:center;transform:rotate(0rad);">
                ...
                />
                <path class="st60" d="M630.6,139.6l-6.7-5.2l3.1-3.9l20-17.1l7.4,5.8l-15.7,20.1l1.6,1.2l-3.3,4.2l-1.6-1.2l-5.2,6.6l-4.9-3.8
                  L630.6,139.6z M633.9,135.5l9.4-12.1L632,134L633.9,135.5z"
                />
                ...
                />
                <path class="st60" d="M779.5,458.6l6.4,0.8c1.2,0.1,1.8-0.2,1.9-1s-0.4-1.2-1.4-1.3l-0.4,0l-9.5-1.1c0.5,0.8,0.8,1.4,0.9,2
                  c0.2,0.6,0.2,1.2,0.1,1.9c-0.2,1.6-0.9,2.8-2.2,3.6c-1.3,0.8-3,1-5.1,0.8l-0.5-0.1l-10.1-1.2l-1-0.1c-2.6-0.3-4.1-1.5-4.7-3.6
                  c-0.1-0.3-0.1-0.6-0.2-0.8c0-0.3,0-0.6,0-0.9c0-0.4,0-0.8,0.1-1.3c0-0.5,0.1-1.2,0.2-1.9c0.1-0.9,0.2-1.6,0.3-2.2s0.2-1.1,0.3-1.5
                  c0.1-0.4,0.3-0.8,0.5-1.1s0.4-0.6,0.7-0.8c0.7-0.7,1.4-1.1,2.1-1.3s1.8-0.2,3.1,0l0.8,0.1l24.6,2.9l1.2,0.1c1.8,0.2,3,0.6,3.8,1.1
                  s1.4,1.4,1.7,2.6c0.1,0.3,0.2,0.5,0.2,0.8c0,0.3,0,0.6,0,0.9s0,0.8-0.1,1.3c0,0.5-0.1,1.1-0.2,1.9c-0.2,1.6-0.4,2.8-0.6,3.5
                  c-0.2,0.7-0.5,1.4-0.9,1.9c-0.6,0.7-1.3,1.2-2.2,1.5s-1.9,0.3-3.2,0.2l-0.5-0.1l-7-0.8L779.5,458.6z M770.5,457.6
                  c0.8,0.1,1.3,0.1,1.6-0.1s0.5-0.4,0.5-0.8c0-0.4-0.1-0.8-0.3-1s-0.8-0.4-1.6-0.5l-8.9-1c-0.9-0.1-1.6-0.1-2,0
                  c-0.4,0.1-0.6,0.4-0.6,0.8c0,0.5,0.1,0.8,0.4,1c0.3,0.2,0.9,0.3,1.8,0.5l0.4,0L770.5,457.6z"
                />
                <path class="st60" d="M753.7,493.5l15.2,12.6c0.6,0.5,1,0.8,1.2,0.8l1.1,0.3l5.2,1.3l0.4,0.1c1.1,0.3,1.8,0,1.9-0.7
                  c0.2-0.8-0.2-1.3-1.2-1.5l-0.4-0.1l-6.1-1.6l1.7-6.4l6.8,1.8l1,0.3c1.2,0.3,2.1,0.8,2.8,1.4c0.7,0.6,1.1,1.5,1.2,2.5
                  c0.1,0.5,0.1,1.2,0,1.8c-0.1,0.7-0.3,1.6-0.6,2.9c-0.2,0.9-0.4,1.7-0.6,2.3c-0.2,0.6-0.4,1.2-0.6,1.6c-0.2,0.4-0.4,0.8-0.6,1
                  s-0.5,0.5-0.8,0.8c-0.7,0.6-1.5,0.9-2.3,1c-0.8,0.1-2-0.1-3.4-0.5l-5.2-1.3c-1.4-0.4-2.6-0.8-3.4-1.2c-0.8-0.4-1.7-1-2.7-1.8
                  l-13.1-11.1l-2.2,8.5l-5.1-1.3l3.9-15.1L753.7,493.5z"
                />
                <path class="st60" d="M773.2,527.1l2.3-7.4l5,1.6l-4.3,13.6l-6.4-2l-28.5-17.5l2-6.4L773.2,527.1z" />
      ...
      <div class="bets d-flex flex-column justify-center align-center" :class="{'bet-ready':!playing}">
        <div class="bets-btns">
          <div v-if="!bettingFinals" class="inner">
            <!-- ZERO -->
            <v-badge color="primary" :content="bets['straight0']" :value="!!bets['straight0']" overlap offset-x="50%" offset-y="50%" class="btn-badge bet v3 bnm">
              <v-btn :disabled="playing" color="primary" outlined :class="{active:win_number==0||active.indexOf(0)!=-1,hover:hover.indexOf(0)!=-1}" @click="placeBet('straight0')">
                0
              </v-btn>
            </v-badge>
            <!-- COLUMN 3 -->
            <div class="bets-sup">
              <v-badge v-for="i in 12" :key="'col-3-street-'+i" color="primary" :content="bets['street'+(i*3-2)]" :value="!!bets['street'+(i*3-2)]" overlap class="betm vt hm">
                <v-btn :disabled="playing" text @click="placeBet('street'+(i*3-2))" @mousedown="active=[i*3-2,i*3-1,i*3-0]" @mouseup="active=[]" @mouseover="hover=[i*3-2,i*3-1,i*3-0]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <div class="bets-sup">
              <v-badge v-for="i in 11" :key="'col-3-sixline-'+i" color="primary" :content="bets['sixline'+(i*3-2)]" :value="!!bets['sixline'+(i*3-2)]" overlap class="betm vt hr szc">
                <v-btn :disabled="playing" text @click="placeBet('sixline'+(i*3-2))" @mousedown="active=[i*3-2,i*3-1,i*3-0,i*3+3,i*3+2,i*3+1]" @mouseup="active=[]" @mouseover="hover=[i*3-2,i*3-1,i*3-0,i*3+3,i*3+2,i*3+1]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <div class="bets-sup">
              <v-badge v-for="i in 11" :key="'col-3-split-'+i" color="primary" :content="bets[`split${i*3-0}_${i*3+3}`]" :value="!!bets[`split${i*3-0}_${i*3+3}`]" overlap class="betm vm hr szhs">
                <v-btn :disabled="playing" text @click="placeBet(`split${i*3-0}_${i*3+3}`)" @mousedown="active=[i*3-0,i*3+3]" @mouseup="active=[]" @mouseover="hover=[i*3-0,i*3+3]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <v-badge v-for="i in 12" :key="'col-3-bet-'+i" color="primary" :content="bets[`straight${i*3-0}`]" :value="!!bets[`straight${i*3-0}`]" overlap class="btn-badge bet">
              <v-btn :disabled="playing" :color="columns_color[i*3-0]=='r'?'red':'black'" :class="{active:win_number==i*3-0||active.indexOf(i*3-0)!=-1,hover:hover.indexOf(i*3-0)!=-1}" @click="placeBet(`straight${i*3-0}`)">
                {{ i*3 - 0 }}
              </v-btn>
            </v-badge>
            <v-badge color="primary" :content="bets['column3']" :value="!!bets['column3']" overlap class="btn-badge bet">
              <v-btn :disabled="playing" color="primary" outlined @click="placeBet('column3')" @mousedown="active=[];for(var i=3;i<37;i+=3)active.push(i);" @mouseup="active=[]" @mouseover="hover=[];for(var i=3;i<37;i+=3)hover.push(i);" @mouseout="hover=[]">
                {{ $t('2:1') }}
              </v-btn>
            </v-badge>
            <div class="break" />
            <!-- COLUMN 2 -->
            <div class="bets-sup">
              <v-badge color="primary" :content="bets['trio23']" :value="!!bets['trio23']" overlap class="betm vb hl szc">
                <v-btn :disabled="playing" text @click="placeBet('trio23')" @mousedown="active=[0,2,3]" @mouseup="active=[]" @mouseover="hover=[0,2,3]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <div class="bets-sup">
              <v-badge v-for="i in 12" :key="'col-2-split-'+i" color="primary" :content="bets[`split${i*3-1}_${i*3-0}`]" :value="!!bets[`split${i*3-1}_${i*3-0}`]" overlap class="betm vt hm szvs">
                <v-btn :disabled="playing" text @click="placeBet(`split${i*3-1}_${i*3-0}`)" @mousedown="active=[i*3-1,i*3-0]" @mouseup="active=[]" @mouseover="hover=[i*3-1,i*3-0]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <div class="bets-sup">
              <v-badge v-for="i in 11" :key="'col-2-corner-'+i" color="primary" :content="bets['corner'+(i*3-1)]" :value="!!bets['corner'+(i*3-1)]" overlap class="betm vt hr szc">
                <v-btn :disabled="playing" text @click="placeBet('corner'+(i*3-1))" @mousedown="active=[i*3-1,i*3,i*3+2,i*3+3]" @mouseup="active=[]" @mouseover="hover=[i*3-1,i*3,i*3+2,i*3+3]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <div class="bets-sup">
              <v-badge v-for="i in 11" :key="'col-2-split-'+i" color="primary" :content="bets[`split${i*3-1}_${i*3+2}`]" :value="!!bets[`split${i*3-1}_${i*3+2}`]" overlap class="betm vm hr szhs">
                <v-btn :disabled="playing" text @click="placeBet(`split${i*3-1}_${i*3+2}`)" @mousedown="active=[i*3-1,i*3+2]" @mouseup="active=[]" @mouseover="hover=[i*3-1,i*3+2]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <v-badge v-for="i in 12" :key="'col-2-bet-'+i" color="primary" :content="bets[`straight${i*3-1}`]" :value="!!bets[`straight${i*3-1}`]" overlap class="btn-badge bet">
              <v-btn :disabled="playing" :color="columns_color[i*3-1]=='r'?'red':'black'" :class="{active:win_number==i*3-1||active.indexOf(i*3-1)!=-1,hover:hover.indexOf(i*3-1)!=-1}" @click="placeBet(`straight${i*3-1}`)">
                {{ i*3 - 1 }}
              </v-btn>
            </v-badge>
            <v-badge color="primary" :content="bets['column2']" :value="!!bets['column2']" overlap class="bet">
              <v-btn :disabled="playing" color="primary" outlined @click="placeBet('column2')" @mousedown="active=[];for(var i=2;i<36;i+=3)active.push(i);" @mouseup="active=[]" @mouseover="hover=[];for(var i=2;i<36;i+=3)hover.push(i);" @mouseout="hover=[]">
                {{ $t('2:1') }}
              </v-btn>
            </v-badge>
            <div class="break" />
            <!-- COLUMN 1 -->
            <div class="bets-sup">
              <v-badge color="primary" :content="bets['trio12']" :value="!!bets['trio12']" overlap class="betm vb hl szc">
                <v-btn :disabled="playing" text @click="placeBet('trio12')" @mousedown="active=[0,1,2]" @mouseup="active=[]" @mouseover="hover=[0,1,2]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <div class="bets-sup">
              <v-badge v-for="i in 12" :key="'col-1-split-'+i" color="primary" :content="bets[`split${i*3-2}_${i*3-1}`]" :value="!!bets[`split${i*3-2}_${i*3-1}`]" overlap class="betm vt hm szvs">
                <v-btn :disabled="playing" text @click="placeBet(`split${i*3-2}_${i*3-1}`)" @mousedown="active=[i*3-2,i*3-1]" @mouseup="active=[]" @mouseover="hover=[i*3-2,i*3-1]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <div class="bets-sup">
              <v-badge v-for="i in 11" :key="'col-1-corner-'+i" color="primary" :content="bets['corner'+(i*3-2)]" :value="!!bets['corner'+(i*3-2)]" overlap class="betm vt hr szc">
                <v-btn :disabled="playing" text @click="placeBet('corner'+(i*3-2))" @mousedown="active=[i*3-2,i*3-1,i*3+1,i*3+2]" @mouseup="active=[]" @mouseover="hover=[i*3-2,i*3-1,i*3+1,i*3+2]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <div class="bets-sup">
              <v-badge v-for="i in 11" :key="'col-1-split-'+i" color="primary" :content="bets[`split${i*3-2}_${i*3+1}`]" :value="!!bets[`split${i*3-2}_${i*3+1}`]" overlap class="betm vm hr szhs">
                <v-btn :disabled="playing" text :data-betsize="bets[`split${i*3-2}_${i*3+1}`]?bets[`split${i*3-2}_${i*3+1}`]:null" @click="placeBet(`split${i*3-2}_${i*3+1}`)" @mousedown="active=[i*3-2,i*3+1]" @mouseup="active=[]" @mouseover="hover=[i*3-2,i*3+1]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <v-badge v-for="i in 12" :key="'col-1-bet-'+i" color="primary" :content="bets[`straight${i*3-2}`]" :value="!!bets[`straight${i*3-2}`]" overlap class="btn-badge bet">
              <v-btn :disabled="playing" :color="columns_color[i*3-2]=='r'?'red':'black'" :class="{active:win_number==i*3-2||active.indexOf(i*3-2)!=-1,hover:hover.indexOf(i*3-2)!=-1}" @click="placeBet(`straight${i*3-2}`)">
                {{ i*3 - 2 }}
              </v-btn>
            </v-badge>
            <v-badge color="primary" :content="bets['column1']" :value="!!bets['column1']" overlap class="bet">
              <v-btn :disabled="playing" color="primary" outlined @click="placeBet('column1')" @mousedown="active=[];for(var i=1;i<35;i+=3)active.push(i);" @mouseup="active=[]" @mouseover="hover=[];for(var i=1;i<35;i+=3)hover.push(i);" @mouseout="hover=[]">
                {{ $t('2:1') }}
              </v-btn>
            </v-badge>
            <div class="break" />
            <!-- BOTTOM BTNS LINE 1-->
            <div class="bets-sup">
              <v-badge color="primary" :content="bets['top_line']" :value="!!bets['top_line']" overlap class="betm vb hl szc">
                <v-btn :disabled="playing" text @click="placeBet('top_line')" @mousedown="active=[0,1,2,3]" @mouseup="active=[]" @mouseover="hover=[0,1,2,3]" @mouseout="hover=[]" />
              </v-badge>
            </div>
            <v-badge color="primary" :content="bets['dozen1']" :value="!!bets['dozen1']" overlap class="btn-badge bet ml1 h4">
              <v-btn :disabled="playing" color="primary" outlined @mousedown="active=[];for(var i=1;i<13;i++)active.push(i);" @mouseup="active=[]" @mouseover="hover=[];for(var i=1;i<13;i++)hover.push(i);" @mouseout="hover=[]" @click="placeBet('dozen1')">
                {{ $t('1st 12') }}
              </v-btn>
            </v-badge>
            <v-badge color="primary" :content="bets['dozen2']" :value="!!bets['dozen2']" overlap class="btn-badge bet h4">
              <v-btn :disabled="playing" color="primary" outlined @mousedown="active=[];for(var i=1;i<13;i++)active.push(i+12);" @mouseup="active=[]" @mouseover="hover=[];for(var i=1;i<13;i++)hover.push(i+12);" @mouseout="hover=[]" @click="placeBet('dozen2')">
                {{ $t('2nd 12') }}
              </v-btn>
            </v-badge>
            <v-badge color="primary" :content="bets['dozen3']" :value="!!bets['dozen3']" overlap class="btn-badge bet mr1 h4">
              <v-btn :disabled="playing" color="primary" outlined @mousedown="active=[];for(var i=1;i<13;i++)active.push(i+24);" @mouseup="active=[]" @mouseover="hover=[];for(var i=1;i<13;i++)hover.push(i+24);" @mouseout="hover=[]" @click="placeBet('dozen3')">
                {{ $t('3rd 12') }}
              </v-btn>
            </v-badge>
            <div class="break" />
            <!-- BOTTOM BTNS LINE 2-->
            <v-badge color="primary" :content="bets['low']" :value="!!bets['low']" overlap class="btn-badge bet ml1 h2">
              <v-btn :disabled="playing" color="primary" outlined @mousedown="active=[];for(var i=1;i<19;i++)active.push(i);" @mouseup="active=[]" @mouseover="hover=[];for(var i=1;i<19;i++)hover.push(i);" @mouseout="hover=[]" @click="placeBet('low')">
                {{ $t('1 to 18') }}
              </v-btn>
            </v-badge>
            <v-badge color="primary" :content="bets['even']" :value="!!bets['even']" overlap class="btn-badge bet h2">
              <v-btn :disabled="playing" color="primary" outlined @mousedown="active=[];for(var i=2;i<37;i+=2)active.push(i);" @mouseup="active=[]" @mouseover="hover=[];for(var i=2;i<37;i+=2)hover.push(i);" @mouseout="hover=[]" @click="placeBet('even')">
                {{ $t('Even') }}
              </v-btn>
            </v-badge>
            <v-badge color="primary" :content="bets['red']" :value="!!bets['red']" overlap class="btn-badge bet h2">
              <v-btn :disabled="playing" color="red" @mousedown="active=[];for(var i=1;i<37;i++)if(columns_color[i]=='r')active.push(i);" @mouseup="active=[]" @mouseover="hover=[];for(var i=1;i<37;i++)if(columns_color[i]=='r')hover.push(i);" @mouseout="hover=[]" @click="placeBet('red')">
                {{ $t('Red') }}
              </v-btn>
            </v-badge>
            <v-badge color="primary" :content="bets['black']" :value="!!bets['black']" overlap class="btn-badge bet h2">
              <v-btn :disabled="playing" color="black" @mousedown="active=[];for(var i=1;i<37;i++)if(columns_color[i]=='b')active.push(i);" @mouseup="active=[]" @mouseover="hover=[];for(var i=1;i<37;i++)if(columns_color[i]=='b')hover.push(i);" @mouseout="hover=[]" @click="placeBet('black')">
                {{ $t('Black') }}
              </v-btn>
            </v-badge>
            <v-badge color="primary" :content="bets['odd']" :value="!!bets['odd']" overlap class="btn-badge bet h2">
              <v-btn :disabled="playing" color="primary" outlined @mousedown="active=[];for(var i=1;i<37;i+=2)active.push(i);" @mouseup="active=[]" @mouseover="hover=[];for(var i=1;i<37;i+=2)hover.push(i);" @mouseout="hover=[]" @click="placeBet('odd')">
                {{ $t('Odd') }}
              </v-btn>
            </v-badge>
            <v-badge color="primary" :content="bets['high']" :value="!!bets['high']" overlap class="btn-badge bet mr1 h2">
              <v-btn :disabled="playing" color="primary" outlined @mousedown="active=[];for(var i=19;i<37;i++)active.push(i);" @mouseup="active=[]" @mouseover="hover=[];for(var i=19;i<37;i++)hover.push(i);" @mouseout="hover=[]" @click="placeBet('high')">
                {{ $t('19 to 36') }}
              </v-btn>
            </v-badge>
            <div class="fixer" />
          ...
          <div v-if="bettingFinals" class="inner">
            ...
            <div class="bet filler" />
            <v-btn :disabled="playing" v-for="i in [0,1,2,3,4]" :key="'btn-finals-'+i" color="primary" outlined class="bet h2" @click="placeFinals(i)">
              {{ i }}
            </v-btn>
            <div class="bet filler" />
            <div class="bet filler" />
            ...
            <div class="bet filler" />
            <div class="bet filler" />
            <v-btn :disabled="playing" v-for="i in [5,6,7,8,9]" :key="'btn-finals-'+i" color="primary" outlined class="bet h2" @click="placeFinals(i)">
              {{ i }}
            </v-btn>
            <div class="break" />
        ...
        <div class="d-md-flex text-center justify-center flex-wrap mt-1">
          <v-btn :disabled="playing" small class="mx-1 my-2 my-lg-0" @click="placeVoisins()">
            {{ $t('Voisins du Zéro') }}
          </v-btn>
          <v-btn :disabled="playing" small class="mx-1 my-2 my-lg-0" @click="placeTiers()">
            {{ $t('Tiers') }}
          </v-btn>
          <v-btn :disabled="playing" small class="mx-1 my-2 my-lg-0" @click="placeOrphelins()">
            {{ $t('Orphelins') }}
          </v-btn>
          <br>
...
import winSound from 'packages/european-roulette/resources/audio/win.wav'
import loseSound from 'packages/european-roulette/resources/audio/lose.wav'

import betSound from 'packages/european-roulette/resources/audio/bet.wav'
import unbetSound from 'packages/european-roulette/resources/audio/unbet.wav'
import noneSound from 'packages/european-roulette/resources/audio/none.wav'
import spinSound from 'packages/european-roulette/resources/audio/spin.wav'
import startSound from 'packages/european-roulette/resources/audio/start.wav'
import stopSound from 'packages/european-roulette/resources/audio/stop.wav'

import PlayControls from '~/components/Games/PlayControls'
import GameMessage from '~/components/Games/GameMessage'

export default {
  name: 'EuropeanRoulette',
  ...
  data () {
    return {
      ...
      bet: 0,
      win: 0,
      max_bet: config('european-roulette.max_bet'),
      min_bet: config('european-roulette.min_bet'),
      ready: false,
      message: null,
      bets_roulette: {},
      bets_old: {},
  ...
  computed: {
    ...
    betChangeAmount () {
      return config('european-roulette.bet_change_amount')
    },
    nonZeroBets () {
  ...
  methods: {
      ...
      if (!this.playing && this.bettingRoulette) {
        ...
        if (w > 150 && w < 200) {
          ...
          bets.forEach((el) => {
            ...
            if (el > 37) { el = el - 37 }
            if (el === 37) { el = 0 }
            el = 'straight' + this.rouletteNums[el]
      ...
      if (!this.playing && this.bettingRoulette) {
        ...
        if (w > 150 && w < 200) {
          ...
          this.rouletteLights.forEach((el, i) => {
            if (el < 0) this.rouletteLights[i] = 37 + el
            if (el >= 37) this.rouletteLights[i] = el - 37
            if (el === 37) this.rouletteLights[i] = 0
          })
    ...
    placeVoisins () {
      ...
      this.win_number = -1
      var isAllow = true
      const bets = ['trio23', 'split4_7', 'split12_15', 'split19_22', 'corner25', 'split32_35', 'split18_21']
      bets.forEach(el => (isAllow = isAllow && ((this.bets[el] ? this.bets[el] : 0) + this.bet * (el === 'trio23' || el === 'corner25' ? 2 : 1) <= this.max_bet)))
      if (isAllow) {
        bets.forEach(el => this.$set(this.bets, el, (this.bets[el] ? this.bets[el] : 0) + this.bet * (el === 'trio23' || el === 'corner25' ? 2 : 1)))
        this.sound(betSound)
      } else { this.sound(noneSound) }
    },
    placeTiers () {
      ...
      this.win_number = -1
      var isAllow = true
      const bets = ['split5_8', 'split10_11', 'split13_16', 'split23_24', 'split27_30', 'split33_36']
      bets.forEach(el => (isAllow = isAllow && ((this.bets[el] ? this.bets[el] : 0) + this.bet <= this.max_bet)))
      if (isAllow) {
        bets.forEach(el => this.$set(this.bets, el, (this.bets[el] ? this.bets[el] : 0) + this.bet))
        this.sound(betSound)
      } else { this.sound(noneSound) }
    },
    placeOrphelins () {
      ...
      this.win_number = -1
      var isAllow = true
      const bets = ['straight1', 'split6_9', 'split14_17', 'split17_20', 'split31_34']
      bets.forEach(el => (isAllow = isAllow && ((this.bets[el] ? this.bets[el] : 0) + this.bet <= this.max_bet)))
      if (isAllow) {
        bets.forEach(el => this.$set(this.bets, el, (this.bets[el] ? this.bets[el] : 0) + this.bet))
        this.sound('bet')
      } else { this.sound('none') }
    },
    placeNeighbours () {
      this.bettingFinals = false
      ...
      this.animation = {
        ...
        render: () => {
          ...
          if (this.animation.wheel_speed > 0) {
            ...
            this.$refs.wheel.style.transform = `rotate(${this.animation.wheel_angle}rad)`
          }
          ctx.save()
        ...
        calculate: () => {
          switch (this.animation.animation_stage) {
            ...
            case 4:
              ...
              break
            case 6: {
              const v = 6 * Math.PI - ((Math.PI * 2 / 37) * this.animation.ball_idx) - this.animation.ball_angle
            ...
            case 7: {
              ...
              if (s >= (this.animation.ball_break_dist - (Math.PI * 2 / 37) / 2 - (Math.PI * 2 / 37) * 6)) {
                this.animation.animation_stage++
            ...
            case 8: {
              ...
              this.animation.ball_position = 360 - (s / this.animation.ball_break_dist) * (360 - 130)
              this.animation.ball_angle = this.animation.ball_angle_ori + s
              if (s >= (this.animation.ball_break_dist - (Math.PI * 2 / 37) / 2 - (Math.PI * 2 / 37) * 2)) {
                this.animation.animation_stage++
            ...
            case 9: {
              ...
              this.animation.ball_angle = this.animation.ball_angle_ori + s
              if (s >= (this.animation.ball_break_dist - (Math.PI * 2 / 37) / 2 - (Math.PI * 2 / 37) * 1)) {
                this.animation.animation_stage++
...
<style lang="scss" scoped>
  ...
  .bets {
     ...
     @media screen and (min-width: 1200px) { margin-left:calc( #{$width1200} + #{$margin}); }
      .betm {
        ...
        ::v-deep .v-badge__badge {
          ...
          top:50% !important;
          transform:translate(-50%,-50%);
          @media screen and (max-width: 992px) { font-size: 0.4rem;height: 16px;min-width: 16px; }
        }
        ...
        button {margin:0;padding:0;width:100%;height:100%;min-width: unset;position: relative;z-index: 11;}
    ...
    .bet {
      ...
      &.bnm{margin-bottom:0;}
      button {
        margin:0;padding:0;width:100%;height:100%;min-width: unset;
        &.black {color:#fafafa;}
